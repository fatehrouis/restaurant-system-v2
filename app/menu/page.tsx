...
const translations = {
  ar: {
    ...
    addItems: "أضف بعض الأصناف",
    total: "الإجمالي",
    confirmOrder: "تأكيد الطلب",
    orderSent: "تم إرسال طلبك!",
    orderArriving: "سيصل طلبك قريباً",
    prepTime: "وقت التحضير: 15-20 دقيقة",
    newOrder: "طلب جديد",
    all: "الكل",
    viewCart: "عرض السلة",
    items: "عناصر",
  ...
  en: {
    ...
    addItems: "Add some items",
    total: "Total",
    confirmOrder: "Confirm Order",
    orderSent: "Your order has been sent!",
    orderArriving: "Your order will arrive soon",
    prepTime: "Preparation time: 15-20 minutes",
    newOrder: "New Order",
    all: "All",
    viewCart: "View Cart",
    items: "items",
  ...
  fr: {
    ...
    orderArriving: "Votre commande arrivera bientôt",
    prepTime: "Temps de préparation: 15-20 minutes",
...
function MenuContent() {
    ...
    const fetchTableNumber = async () => {
      if (tableId) {
        const { data } = await supabase
          ...
          .eq("id", tableId)
          .single();
        if (data) setTableNumber(data.table_number.toString());
      }
    };
    fetchTableNumber();
  }, [tableId]);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 to-green-100 flex items-center justify-center p-6">
        <div className="bg-white rounded-3xl shadow-2xl p-10 text-center max-w-md w-full animate-scale-in">
          ...
          <p className="text-gray-500 text-lg mb-2">{t.orderArriving}</p>
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24" dir={lang === "ar" ? "rtl" : "ltr"}>
      {/* Language Selector */}
        ...
        <div className="grid grid-cols-2 gap-4">
          {filteredItems.map((item, index) => (
            ...
            >
              ...
              <p className="text-orange-500 font-bold text-center text-lg mb-3">
      ...
      {isCartOpen && (
        <div className="fixed inset-0 z-50">
          ...
          />
          <div
            className={`absolute top-0 bottom-0 w-full max-w-md bg-white shadow-2xl animate-slide-in ${
              ...
              <div className="flex-1 overflow-y-auto p-4">
                {cart.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-gray-400">
                    ...
                    <p className="text-sm mt-1">{t.addItems}</p>
                  </div>
                ) : (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="bg-red-50 text-red-400 w-8 h-8 rounded-lg hover:bg-red-100 transition flex items-center justify-center ml-1"
                          >
      ...
      {cart.length > 0 && !isCartOpen && (
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-white/80 backdrop-blur-lg border-t border-gray-100">
          ...
          >
            ...
            {t.viewCart} ({totalItems} {t.items}) - {total} {t.currency}
            <ChevronLeft
